...
# === Dateipfade ===
logfile1 = ("../Fine Tuning/results/results_EfficientNetB3_tuning/results_EfficientNetB3_tuning_r2"
            "/transfertrainingsverlauf_EfficientNetB3_tuning_r2.txt")
logfile2 = ("../Feature Extraction/results/results_EfficientNetB3_FE/results_EfficientNetB3_FE_r1"
            "/transfertrainingsverlauf_EfficientNetB3_FE_r1.txt")
plot_path = "EfficientNetB3_vergleich.png"
...
fig.suptitle("EfficientNetB3: Feature Extraction vs. Fine Tuning", fontsize=16)
