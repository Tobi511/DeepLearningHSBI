...
#---------------------------------------------------------------------------------------------------------
# Image size auf 32 x 32 verkleinert, batch size auf 64, epochen 50
#---------------------------------------------------------------------------------------------------------
...
plt.tight_layout()
plt.savefig("results\\results_v3.5.5\\trainingsverlauf_v3.5.5.png")  # <- Speichert den Plot als Bild
