...
# Testdaten einlesen
test_data_dir = "C:\\#Informatik Studium\\6. Semester\\DeepLearning\\Projekt stuff\\Vegetable Images\\test"  # Passe den Pfad ggf. an
...
# Modell laden
model = load_model("../1st_wave/models/model_v16.h5")
