...
#---------------------------------------------------------------------------------------------------------
# v5, aber veränderte dataaugmentation UND l2 regularizierer und dropout wert verringert (wichtig und gut)
# bzw.
# v7, aber ohne dataaugmentation
#---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Dense(180, activation='relu', kernel_regularizer=regularizers.l2(0.0001)),
...
plt.tight_layout()
plt.savefig("results\\results_v7.5\\trainingsverlauf_v7.5.png")  # <- Speichert den Plot als Bild
