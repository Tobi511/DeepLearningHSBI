...
model.save("models\\model_v17.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v17\\trainingsverlauf_v17.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v17"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v17.txt"), "w") as f:
