...
model.save("models\\model_v23.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v23\\trainingsverlauf_v23.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v23"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v23.txt"), "w") as f:
