...
# ---------------------------------------------------------------------------------------------------------
# Veränderung im Vergleich zu v10: Dropout erhöhen, weiterer L2 regularizierer in der ersten Dense layer,
# Dense Layer units verringert
# ---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Dense(128, activation='relu', kernel_regularizer=regularizers.l2(0.00025)),
    layers.BatchNormalization(),
    layers.Dropout(0.2),
