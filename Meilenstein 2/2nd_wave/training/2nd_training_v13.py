...
# ---------------------------------------------------------------------------------------------------------
# Veränderung im Vergleich zu v12: andere Batch size, Dropout in jeder Layer
# Weitere Werte testen für: Dense Layer units, l2 regularizierer, dropout
# ---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Dense(256, activation='relu', kernel_regularizer=regularizers.l2(0.0002)),
    layers.BatchNormalization(),
    layers.Dropout(0.35),
