...
# ---------------------------------------------------------------------------------------------------------
# Veränderung im Vergleich zu v11: Dense Layer Units deutlich erhöht, Dropout etwas erhöht
# ---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Dense(512, activation='relu', kernel_regularizer=regularizers.l2(0.00025)),
    layers.BatchNormalization(),
    layers.Dropout(0.3),
