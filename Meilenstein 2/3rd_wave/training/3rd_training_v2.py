...
# ---------------------------------------------------------------------------------------------------------
# Veränderungen im Vergleich zu v1: BatchNormalization in jeder Layer, aktivierungsfunktion erst nach
# der BatchNormalization, weniger Dense Layer units, höhere ConvLayer filter anzahl
# ---------------------------------------------------------------------------------------------------------
