...
#---------------------------------------------------------------------------------------------------------
# # ausgehende von v19 (war gute version), jetzt mit batchnormalization und batch size erhöhen (nicht sehr gut geworden, viel gespringe)
#---------------------------------------------------------------------------------------------------------
...
model.save("models\\model_v21.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v21\\trainingsverlauf_v21.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v21"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v21.txt"), "w") as f:
