...
#---------------------------------------------------------------------------------------------------------
# # v13, aber überall batchnormalization
#---------------------------------------------------------------------------------------------------------
...
model.save("models\\model_v14.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v14\\trainingsverlauf_v14.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v14"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v14.txt"), "w") as f:
