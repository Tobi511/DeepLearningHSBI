...
#---------------------------------------------------------------------------------------------------------
# # filters erhöhen, wegen höherer data augmentation
#---------------------------------------------------------------------------------------------------------
...
model.save("models\\model_v19_komplett.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v19\\kompletterDurchlauf\\trainingsverlauf_v19_komplett.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v19/kompletterDurchlauf"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v19_komplett.txt"), "w") as f:
