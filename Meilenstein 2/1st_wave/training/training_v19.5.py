...
model.save("models\\model_v19.5.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v19.5\\trainingsverlauf_v19.5.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v19.5"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v19.5.txt"), "w") as f:
