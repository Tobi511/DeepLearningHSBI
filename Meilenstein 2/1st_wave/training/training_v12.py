...
#---------------------------------------------------------------------------------------------------------
# Veränderung im Vergleich zu v11: weniger convlayer filter, weniger dense layer units, niedrigerer dropout
#---------------------------------------------------------------------------------------------------------
...
plt.tight_layout()
plt.savefig("results\\results_v12\\trainingsverlauf_v12.png")  # <- Speichert den Plot als Bild
