...
#---------------------------------------------------------------------------------------------------------
# v10, aber weniger dense layer units
#---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Dense(400, activation='relu', kernel_regularizer=regularizers.l2(0.0001)),
...
plt.tight_layout()
plt.savefig("results\\results_v11\\trainingsverlauf_v11.png")  # <- Speichert den Plot als Bild
