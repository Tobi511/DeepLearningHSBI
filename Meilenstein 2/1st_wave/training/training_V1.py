...
#---------------------------------------------------------------------------------------------------------
# Basis Modell, keine Extras, nur die Anforderungen and die Hidden Layers und Dense Layers laut Vorlesung erfüllt
#---------------------------------------------------------------------------------------------------------
...
plt.tight_layout()
plt.savefig("results\\results_v1\\trainingsverlauf_v1.png")  # <- Speichert den Plot als Bild
