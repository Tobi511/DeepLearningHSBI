...
# ---------------------------------------------------------------------------------------------------------
# # v19, aber etwas kleinere filter und weitere dense layer
# ---------------------------------------------------------------------------------------------------------
...
model = keras.Sequential([
    ...
    layers.Conv2D(192, 3, activation='relu', padding='same'),
    layers.MaxPooling2D(pool_size=2),
...
model.save("models\\model_v22.h5")
...
plt.tight_layout()
plt.savefig("results\\results_v22\\trainingsverlauf_v22.png")  # <- Speichert den Plot als Bild

# Ergebnisse in eine Textdatei speichern
results_dir = "../results/results_v22"
os.makedirs(results_dir, exist_ok=True)

with open(os.path.join(results_dir, "trainingsverlauf_v22.txt"), "w") as f:
